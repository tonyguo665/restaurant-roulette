...
Server set up for the restaurant roulette application located at: [Restaurant Roulette](https://github.com/tonyguo665/restaurant-roulette).
...
1. Change to the root directory of the repo and run `npm install`
2. 
